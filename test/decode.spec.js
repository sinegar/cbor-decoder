import { decode, fromHex } from '../src';

// https://codesandbox.io/s/cbor-decoder-yy28c?file=/test/decode.spec.js https://github.com/aaronhuggins/cbor-redux/blob/master/test/testcases.ts
...
[
   ...
   ['ByteString []', '40', []],
   ['Bytestring [1,2,3,4]', '4401020304', [1, 2, 3, 4]],
   ['Bytestring [1,2,3,4,5]', '5f42010243030405ff', [1, 2, 3, 4, 5], true],
   ["String ''", '60', ''],
   ["String 'a'", '6161', 'a'],
   ...
   it(test[0], () => expect(decode(fromHex(test[1]))).toEqual(test[2]))
);
